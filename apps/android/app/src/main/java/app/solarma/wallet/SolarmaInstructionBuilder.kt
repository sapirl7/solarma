...
class SolarmaInstructionBuilder @Inject constructor() {
    ...
    companion object {
        ...
        private val DISCRIMINATOR_SLASH = byteArrayOf(
    ...
    fun buildEmergencyRefund(
        ...
        Log.d(TAG, "Building emergency_refund: alarm=${alarmPda.toBase58()}, vault=${vaultPda.address.toBase58()}, sink=${sinkAddress.toBase58()}")
    ...
    fun buildSlash(
        ...
        Log.d(TAG, "Building slash: alarm=${alarmPda.toBase58()}, vault=${vaultPda.address.toBase58()}, recipient=${penaltyRecipient.toBase58()}")
     ...
     */
    fun deriveAlarmPda(owner: PublicKey, alarmId: Long): PdaResult {
     ...
     */
    private fun findProgramDerivedAddress(seeds: List<ByteArray>, programId: PublicKey): PdaResult {
