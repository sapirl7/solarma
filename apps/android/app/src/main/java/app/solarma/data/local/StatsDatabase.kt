...
data class StatsEntity(
    @PrimaryKey
    val id: Int = 1, // Single row for stats
...
interface StatsDao {
    ...
    @Query("UPDATE stats SET currentStreak = currentStreak + 1, longestStreak = MAX(longestStreak, currentStreak + 1), totalWakes = totalWakes + 1, lastWakeAt = :timestamp WHERE id = 1")
