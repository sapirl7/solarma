    ...
    constructor(
        ...
        suspend fun buildAckAwakeTransactionByPubkey(
            ...
            withContext(Dispatchers.IO) {
                ...
                val instruction =
                    instructionBuilder.buildAckAwake(
                        owner = owner,
                        alarmPda = alarmPda,
                    )
        ...
        private fun buildSortedAccountMetas(
            ...
            return accountMap.values.sortedWith(
                compareBy(
                    // Signers first
                    { !it.isSigner },
                    // Writable first within each group
                    { !it.isWritable },
...
enum class PenaltyRoute(val code: Byte) {
    ...
    // Project treasury for Solarma development
    DONATE(1),
